...
class _ExampleStaggeredAnimationsState extends State<ExampleStaggeredAnimations>
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      title: const Text('Menu Animado', style: TextStyle(color: Colors.white)),
  ...
  Widget _buildContent() {
    // Conteúdo principal da página (vazio ou o que você quiser colocar)
    return const Center(
      child: Text(
        'Página principal',
...
class _MenuState extends State<Menu> with SingleTickerProviderStateMixin {
  ...
  Duration get _animationDuration => _initialDelayTime +
